...
rule process_mirtarbase:
    input: mirtarbase = "../data/processed/intermediary/hsa_MTI.tsv", rnamapping = "../data/processed/mappings/rnacentral_tarbase_human_mapping.tsv", genemapping = "../data/processed/mappings/ensembl_to_entrez.tsv"
